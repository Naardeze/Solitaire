...
import static solitaire.Card.CARD_WIDTH;
import static solitaire.Card.CARD_HEIGHT;
...
final public class Game extends JLabel implements MouseListener, Runnable {
    ...
    public Game(GameType gameType) {
        ...
        setOpaque(true);
        setBackground(new Color(-16728576));
        setHorizontalAlignment(JLabel.CENTER);
        setFont(deck.getFont().deriveFont((float) CARD_HEIGHT / 3));
    ...
    public void mouseReleased(MouseEvent e) {
        if (getComponentAt(e.getPoint()) instanceof Pile) {
